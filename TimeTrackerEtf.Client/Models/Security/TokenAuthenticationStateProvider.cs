...
namespace TimeTrackerEtf.Client.Models.Security
{
    public class TokenAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        public IEnumerable<Claim> GetClaimsFromTokenAndUser(string token, UserModel user)
        {
        ...
        {
            return await _jsRuntime.InvokeAsync<UserModel>("blazorLokalStorage.get", "user");
        }

        public async Task<string> GetTokenAsync()
        {
            return await _jsRuntime.InvokeAsync<string>("blazorLokalStorage.get", "authToken");
        }
